<div class="container py-3">
    ...
    <div class="row">
        ...
        <div class="col-6 text-right">
            <a href="<?php echo route('products insert') ?>" class="btn btn-success">Create</a>
        </div>
    </div>
    <?php if (count($arr) == 0) : ?>
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td>
                <img src="<?php echo $itemarr["image"] ?>" alt="" style="width: 100px">
            </td>
            <td>
                <a class="btn btn-sm btn-primary"
                    href="<?php echo route('products update') ?>&product_id=<?php echo $itemarr["id"] ?>">Update</a>
                <a class="btn btn-sm btn-danger"
                    href="<?php echo route('products delete') ?>&product_id=<?php echo $itemarr["id"] ?>"
                    onclick="return confirm('Bạn có muốn xóa sản phẩm?')">Delete</a>
            </td>
        </tr>
